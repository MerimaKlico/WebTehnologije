...
//<?php echo htmlspecialchars($_SERVER['PHP_SELF']); 
  ...
  if($valid){
   header("Location: provjeravanje2.php?firstName=$firstName&lastName=$lastName&message=$message&email=$email&email2=$email2&tel=$tel&mjesto=$mjesto&opcina=$opcina&datum=$datum");
   exit();
  }
